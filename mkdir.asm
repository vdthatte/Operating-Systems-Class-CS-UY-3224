...
main(int argc, char *argv[])
{
  ...
  4d:	50                   	push   %eax
  4e:	e8 e2 02 00 00       	call   335 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	8a 80 74 0a 00 00    	mov    0xa74(%eax),%al
...
printf(int fd, char *fmt, ...)
{
 ...
 516:	75 07                	jne    51f <printf+0xe0>
          s = "(null)";
 518:	c7 45 f4 1e 08 00 00 	movl   $0x81e,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 5d8:	a1 90 0a 00 00       	mov    0xa90,%eax
...
free(void *ap)
{
 ...
 6a3:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 6a8:	c9                   	leave  
 6a9:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 700:	83 c4 10             	add    $0x10,%esp
  return freep;
 703:	a1 90 0a 00 00       	mov    0xa90,%eax
}
 708:	c9                   	leave  
 709:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 71a:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 71d:	a1 90 0a 00 00       	mov    0xa90,%eax
 722:	89 45 f0             	mov    %eax,-0x10(%ebp)
 725:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 729:	75 23                	jne    74e <malloc+0x44>
    base.s.ptr = freep = prevp = &base;
 72b:	c7 45 f0 88 0a 00 00 	movl   $0xa88,-0x10(%ebp)
 732:	8b 45 f0             	mov    -0x10(%ebp),%eax
 735:	a3 90 0a 00 00       	mov    %eax,0xa90
 73a:	a1 90 0a 00 00       	mov    0xa90,%eax
 73f:	a3 88 0a 00 00       	mov    %eax,0xa88
    base.s.size = 0;
 744:	c7 05 8c 0a 00 00 00 	movl   $0x0,0xa8c
 74b:	00 00 00 
  }
 ...
 7a1:	a3 90 0a 00 00       	mov    %eax,0xa90
      return (void*)(p + 1);
 ...
 7ac:	eb 3b                	jmp    7e9 <malloc+0xdf>
    ...
    if(p == freep)
 7ae:	a1 90 0a 00 00       	mov    0xa90,%eax
